...
public class JwtUtils {
    ...
    //Metodo que prepara a chave que vai ser criptografada
    private static SecretKey generateKey(){
        return Keys.hmacShaKeyFor(SECRET_KEY.getBytes(StandardCharsets.UTF_8));
    }

    //Metodo que define a duração do token
    ...
    //Metodo para recuperar conteúdo do token
    ...
    //Para retornar o token sem o 'Bearer'
